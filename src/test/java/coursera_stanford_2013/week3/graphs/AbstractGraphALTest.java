...
public abstract class AbstractGraphALTest {
    ...
    @Test
    public void should_remove_edges_after_removing_vertex() {
        // given
        int key1 = 1;
        int key2 = 2;
        int key3 = 3;
    ...
    public void should_perform_contraction_between_two_vertices() {
        ...
        assertFalse(graph.hasVertex(key3));

        assertEquals(2, graph.countOfEdges(newKey, key2));
        assertTrue(graph.hasEdge(newKey, key2));
    ...
    public void should_clone_vertices_and_edges() throws CloneNotSupportedException {
        ...
        // > when
        GraphAL clonedInstance = graph.clone();
    ...
    private void assertVerticesEquals(GraphAL clonedInstance) {
    ...
    private void assertEdgesEquals(GraphAL clonedInstance) {
    ...
    private void assertSizeOfEdgesAndVerticesEquals(GraphAL clonedInstance) {
